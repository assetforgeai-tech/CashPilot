...
def test_earnapp_runtime_policy_allows_dedicated_multiplatform_lanes_without_changing_other_providers():
    ...
    assert catalog_policy["lifecycle_actions"]["banned"] == "recreate"
...
def test_catalog_lifecycle_matches_lane_dispatch_policy():
    ...
    assert earnapp["lane_lifecycle"]["proxy"]["banned"] == "recreate"
    packetstream = provider_runtime.catalog_runtime("packetstream")
    assert packetstream["lane_lifecycle"]["proxy"]["banned"] == "observe"
