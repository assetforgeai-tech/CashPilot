...
- [x] Enforce the HTTP lease/release/rotate API to accept proxy lanes only; persist `lane='proxy'` in provider lease records with backward-compatible migration.
