...
| `CASHPILOT_EARNAPP_AGENT_SOCKET` | `/run/cashpilot-earnapp-agent/agent.sock` | Restricted Unix socket used only by the official EarnApp Ubuntu LXD helper; this is not the raw LXD socket. | — |
