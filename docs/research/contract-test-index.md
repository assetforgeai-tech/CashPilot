...
Ngày lập: 2026-08-21. Đây là chỉ mục từ source/tests trong repo, không phải live verification.
...
| NKN Wallet | Wallet import, inventory and lease boundary | `tests/test_nkn_wallets_module.py` | Source/test evidence; live unknown |
...
- Không có live NKN wallet snapshot trong repo hiện tại.
