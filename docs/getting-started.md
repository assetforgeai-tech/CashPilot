...
Of these, **18 providers** can be deployed and managed automatically via Docker, and **12 collectors** can read earnings from provider APIs or dashboards. Providers without collectors remain deployable but need dashboard/manual verification for earnings.
